...
public class ClientHandler {
    ...
    public Process handleClient(Socket clientSocket, Server server) {
        try {
            ...
            while (clientConnected) {
                ...
                if(input.equals("REQUEST_AVERAGE_WAIT_TIME")) {
                    double averageWaitTime = server.getAverageProcessTime();
                    writer.println("Average wait time: " + averageWaitTime);
                } else{
                    try {
